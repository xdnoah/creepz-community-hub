...
export function MobileAuth() {
  ...
  return (
    <div className="mobile-container bg-win95-gray">
      <div className="flex flex-col items-center justify-center flex-1 p-6">
        <div className="w-full max-w-md bg-win95-gray border-4 border-t-white border-l-white border-b-gray-800 border-r-gray-800 p-6">
          {/* Title */}
          <h1 className="text-2xl font-bold mb-6 text-center">Creepz Community Hub</h1>
